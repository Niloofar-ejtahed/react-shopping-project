...
export default function ProductCategory() {
    ...
    return (
        <div className='flex grid xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 justify-between'>
            {data?.map((item, index) => {
                return <div key={item} role='button' className="mb-2 card bg-base-100 w-72 shadow-xl  transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-90 hover:bg-gray-300 duration-300 ...">
